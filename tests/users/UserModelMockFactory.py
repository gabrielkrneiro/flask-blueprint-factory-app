...
class UserModelMockFactory:
    ...
    def __init__(self, number_of_users: int):
        """ __new__ is used instead of __init__ because have to be a list assigned as 
        UserModelMockFactory instance, not an object. The value assigned to its instance
        will be the value returned from __new__ """
        self.user_list = []
